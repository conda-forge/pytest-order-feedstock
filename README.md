...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-order-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11838&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-order-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-order` can be installed with:

```
conda install pytest-order
```

It is possible to list all of the versions of `pytest-order` available on your platform with:
